# tabbable [![Build Status](https://travis-ci.org/pisinr/tabbable.svg?branch=master)](https://travis-ci.org/pisinr/tabbable)

The different of this fork is that it support setting tabbable query selector.
Use `setTabbableSelector(stringOrFunction)` to customize.
